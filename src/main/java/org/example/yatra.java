...
public class yatra {
    ...
    public void launcher() throws InterruptedException {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\VICTUS\\Downloads\\chromedriver (1).exe");
    ...
    public void booking( String depart , String going) throws InterruptedException {
        ...
        WebElement selectDepartDate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@aria-label=\"10 october 2022\"]/parent::td")));
        selectDepartDate.click();

        WebElement selectReturnDate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@aria-label=\"11 october 2022\"]/parent::td")));
